...
plot_dir <- "OPT_PHASE_Va_NLM_PLOTS"
if (!dir.exists(plot_dir)) dir.create(plot_dir)

csv_dir <- "FRQ_OPT_VERSION_A_PHS_LONG"
...
for (csv_file in csv_files) {
  ...
  if (!is.null(best_model)) {
    ...
    pdf_file <- file.path(plot_dir, paste0("OPT_FRQ_PHS_Va_NLM_PLOT_", id, ".pdf"))
...
write.csv(RED_SUMMARY, "..//FRQ_OPT_Va_NLM_PHS_SUMMARY.csv", row.names = FALSE)
