...
plot_dir <- "LF_PHASE_NLME_PLOTS"
if (!dir.exists(plot_dir)) dir.create(plot_dir)

# Define the folder containing CSV files
csv_dir <- "F:/SRCD_25_ANALYSIS/WAVELET/LONG_LOW_FREQ_PHASE_SERIES"
...
for (csv_file in csv_files) {
  ...
  pdf_file <- file.path(plot_dir, paste0("LF_PHS_NLME_PLOT_", id, ".pdf"))
...
write.csv(summary_df, "LF_NLME_PHASE_SUMMARY.csv", row.names = FALSE)
cat("Summary saved to LF_NLME_PHASE_SUMMARY.csv\n")
